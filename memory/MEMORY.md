...
- **Seguimientos** (PO distinto al de ODS): restructure UX F0-F4 cubierta. Milestone GitHub `Cerrar Seguimientos v1` con F1 #53 + F2 #54 cerrados; siguiente epic F3 #55 Empresas cleanup, luego F4 #56 polish. No iniciar epic sin brief PO.
...
- Para Seguimientos (PO distinto al de ODS), F1 #53 + F2 #54 cerrados; siguiente epic F3 #55 Empresas cleanup. Luego F4 #56 polish. No iniciar epic sin brief PO.
