...
- Expansion v2 E3.4a cerrada como inventario read-only y E3.4a.2 documentada como contrato operativo: tarifas, motor ODS y `payload_normalized` respaldan una matriz de servicios/proyecciones sin aumentar finalizacion; interpretes se modelan como linea vinculada sugerida o excepcional justificada; siguiente foco aprobar contrato antes de E3.4b.
