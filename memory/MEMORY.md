...
- Expansion v2 E3.5b implementada localmente en `codex/e3-profesionales-empresas`: motor/API read-only conservador para `GET /api/empresas/[id]/ciclo-vida`, con contrato tipado sin payload crudo, ramas de empresa/perfil/persona, evidencia sin clasificar, ramas archivadas y warnings de calidad. Post-QA distingue match por NIT vs fallback por nombre, ordena por fecha operativa y sanitiza links.

## Siguiente foco recomendado

- Cerrar QA/commit de E3.5b y luego planear E3.5c: primera UI expandible simple en detalle de empresa usando `GET /api/empresas/[id]/ciclo-vida`.
