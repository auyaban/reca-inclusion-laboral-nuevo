...
- Queda abierto un proyecto formal de prewarm y finalizacion segura en `memory/roadmap.md`: Fase 0 y Fase 1 ya quedaron implementadas localmente; siguen Fase 2/3 para cerrar lock por identidad, delete seguro, cleanup seguro y `strictDraftPersistence` real antes de ampliar prewarm temprano.
...
- Ejecutar Fase 2 y Fase 3 del proyecto de prewarm y finalizacion segura: claim atomico por identidad, delete seguro, cleanup seguro y `strictDraftPersistence` real antes de ampliar prewarm temprano. Re-medir Fase 1 cuando existan finalizaciones nuevas con esta version desplegada.
