...
- Follow-ups acordados (pendientes): #115 cleanup 17 lint warnings preexistentes (16 unused vars + 1 react-hooks/exhaustive-deps en Seccion4 como fix defensivo), #116 investigacion PO Seguimientos sobre warnings funcionales en `SeguimientosBaseStageEditor`.
