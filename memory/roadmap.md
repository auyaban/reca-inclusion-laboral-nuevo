...
1. Hacer QA manual corto del preview vigente de `Interprete LSC`, incluyendo lookup por cedula en `Oferentes / vinculados`, horas, Sabana y finalizacion.
...
| Interprete LSC | `interprete-lsc` | Preview vigente con lookup por cedula en oferentes (`usuarios_reca`), Fase 5 validada, UX/UI pulido y prewarm listo por `env`; sigue fuera de `DEFAULT_PREWARM_PILOT_SLUGS` |
