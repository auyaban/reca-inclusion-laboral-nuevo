...
- Tanda 2 en progreso: epic #69 telemetria silenciosa.
  ...
  - Siguiente: #62 snapshot motor en path de import (Niveles 2/3/4) — primer caller real del RPC `record`. Despues #63 snapshot manual, #64 finalize/mismatch, #65 vista admin, #66 doc.
