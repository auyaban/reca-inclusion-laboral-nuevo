...
function buildBody() {
  ...
  formData.discapacidades = [
    { discapacidad: "Visual", descripcion: "A" },
    { discapacidad: "Auditiva", descripcion: "B" },
    { discapacidad: "Fisica", descripcion: "C" },
    { discapacidad: "Cognitiva", descripcion: "D" },
    { discapacidad: "Psicosocial", descripcion: "E" },
  ];
  formData.asistentes = [
...
function buildResumeArtifacts() {
  return {
    sheetLink: "https://sheets.example/condiciones-vacante",
    ...
    pdfLink: "https://drive.example/cached-condiciones.pdf",
  };
}
    ...
    footerMutationMarkers: [
      {
        ...
        actaRef: "ACTA-CV-1",
        initialRowIndex: 180,
        expectedFinalRowIndex: 181,
      },
    ],
  };
}

describe("POST /api/formularios/condiciones-vacante resume", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    ...
    uploadPdfMock.mockResolvedValue({
      fileId: "pdf-file-id",
      webViewLink: "https://drive.example/condiciones.pdf",
    });
    uploadJsonArtifactMock.mockResolvedValue({
      fileId: "json-file-id",
      webViewLink: "https://drive.example/condiciones-raw.json",
    });
  });
  ...
  it("resumes after a crash between structural insertions and final cell writes without rewriting the sheet", async () => {
    ...
    inspectFooterActaWritesMock
      .mockResolvedValueOnce([
        {
          sheetName: "3. REVISIÃ“N DE LAS CONDICIONES DE LA VACANTE",
          rowIndex: 110,
          columnIndex: 0,
          range: "'3. REVISIÃ“N DE LAS CONDICIONES DE LA VACANTE'!A111",
      ...
      .mockResolvedValueOnce([
        {
          ...
          rowIndex: 180,
          columnIndex: 0,
          range: `'${CONDICIONES_VACANTE_SHEET_NAME}'!A181`,
          value: "www.recacolombia.org\nACTA ID: ACTA-CV-1",
          currentValue: "www.recacolombia.org",
          applied: false,
        },
      ...
      .mockResolvedValueOnce([
        {
          ...
          rowIndex: 181,
          columnIndex: 0,
          range: `'${CONDICIONES_VACANTE_SHEET_NAME}'!A182`,
          value: "www.recacolombia.org\nACTA ID: ACTA-CV-1",
          currentValue: "www.recacolombia.org\nACTA ID: ACTA-CV-1",
          applied: true,
        },
    ...
    await expect(secondResponse.json()).resolves.toEqual({
      success: true,
      sheetLink: "https://sheets.example/condiciones-vacante",
      pdfLink: "https://drive.example/condiciones.pdf",
    });
