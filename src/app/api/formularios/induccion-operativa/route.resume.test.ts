...
import { INDUCCION_OPERATIVA_SHEET_NAME } from "@/lib/finalization/induccionOperativaSheet";
...
function buildResumeArtifacts() {
  return {
    ...
    pdfLink: "https://drive.example/cached-induccion-operativa.pdf",
  };
}
...
describe("POST /api/formularios/induccion-operativa resume", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("resumes after a crash between structural insertions and final cell writes without rewriting the sheet", async () => {
    prepareFinalizationSpreadsheetPipelineMock.mockResolvedValue({
      preparedSpreadsheet: {
        ...
        activeSheetName: "7. INDUCCIÃ“N OPERATIVA",
        activeSheetId: 901,
        sheetLink: "https://sheets.example/induccion-operativa",
    ...
    inspectFooterActaWritesMock
      .mockResolvedValueOnce([
        {
          sheetName: "7. INDUCCIÃ“N OPERATIVA",
          rowIndex: 110,
          columnIndex: 0,
          range: "'7. INDUCCIÃ“N OPERATIVA'!A111",
      ...
      .mockResolvedValueOnce([
        {
          ...
          rowIndex: 110,
          columnIndex: 0,
          range: `'${INDUCCION_OPERATIVA_SHEET_NAME}'!A111`,
          value: "www.recacolombia.org\nACTA ID: ACTA-IND-1",
          currentValue: "www.recacolombia.org",
          applied: false,
        },
      ...
      .mockResolvedValueOnce([
        {
          ...
          rowIndex: 111,
          columnIndex: 0,
          range: `'${INDUCCION_OPERATIVA_SHEET_NAME}'!A112`,
          value: "www.recacolombia.org\nACTA ID: ACTA-IND-1",
          currentValue: "www.recacolombia.org\nACTA ID: ACTA-IND-1",
          applied: true,
        },
