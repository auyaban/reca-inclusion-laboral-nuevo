...
export default async function AsesoresAdminPage({ searchParams }: PageProps) {
  ...
  const result = await listCatalogoRecords({ kind: "asesores", params });

  return <CatalogosListView kind="asesores" result={result} params={params} />;
}
