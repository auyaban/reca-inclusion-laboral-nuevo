...
export default async function GestoresAdminPage({ searchParams }: PageProps) {
  ...
  const result = await listCatalogoRecords({ kind: "gestores", params });

  return <CatalogosListView kind="gestores" result={result} params={params} />;
}
