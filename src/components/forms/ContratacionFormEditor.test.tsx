...
import ContratacionFormEditor from "@/components/forms/ContratacionFormEditor";

describe("ContratacionFormEditor", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("renders loading state", () => {
    ...
    const html = renderToStaticMarkup(<ContratacionFormEditor />);
