...
type CondicionesVacanteCompanySectionProps = {
...
export function CondicionesVacanteCompanySection({
  empresa,
  fechaVisita,
  modalidad,
  nitEmpresa,
  ...
  onSelectEmpresa,
  disabled = false,
}: CondicionesVacanteCompanySectionProps) {
  if (!empresa) {
    ...
    <div className="space-y-5">
      <div className="flex items-start gap-3 rounded-2xl border border-reca-100 bg-reca-50 p-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Esta revisión ya quedó asociada a{" "}
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5">
        <div className="mb-4">
          ...
          <p className="mt-1 text-xs text-gray-500">
            Fecha y modalidad siguen siendo editables. El NIT se sincroniza
            automaticamente con la empresa seleccionada.
          </p>
        </div>
