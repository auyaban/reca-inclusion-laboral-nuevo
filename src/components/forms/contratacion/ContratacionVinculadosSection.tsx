...
const PERSONAL_FIELDS = [
  ...
  {
    name: "certificado_porcentaje",
    label: "Certificado porcentaje",
    kind: "text",
    placeholder: "Ej: 45%",
  },
  {
    ...
    label: "Discapacidad",
    kind: "select",
    options: CONTRATACION_DISCAPACIDAD_OPTIONS,
  },
  {
    name: "telefono_oferente",
    label: "Teléfono del vinculado",
    kind: "text",
  ...
  {
    name: "correo_oferente",
    label: "Correo del vinculado",
    kind: "text",
  ...
  },
  {
    ...
    kind: "select",
    options: CONTRATACION_LGTBIQ_OPTIONS,
  },
  {
    name: "grupo_etnico",
    label: "Grupo étnico",
    kind: "select",
    options: CONTRATACION_GRUPO_ETNICO_OPTIONS,
  },
  {
    name: "grupo_etnico_cual",
    label: "Grupo étnico - cuál",
    kind: "select",
    options: CONTRATACION_GRUPO_ETNICO_CUAL_OPTIONS,
  },
  {
    name: "cargo_oferente",
    label: "Cargo del vinculado",
    kind: "text",
  ...
  },
  {
    ...
    label: "Parentesco",
    kind: "text",
    placeholder: "Relación con el vinculado",
  },
  {
  ...
  },
  {
    ...
    label: "Cuenta con certificado de discapacidad",
    kind: "select",
    options: CONTRATACION_CERTIFICADO_DISCAPACIDAD_OPTIONS,
  },
  {
...
const SUPPORT_GROUPS = [
  {
    ...
    description:
      "Acompañamiento para lectura y comprensión inicial del contrato.",
    fields: [
      {
        name: "contrato_lee_nivel_apoyo",
        label: "Nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "contrato_lee_observacion",
        label: "Observación",
        kind: "select",
        options: CONTRATACION_LECTURA_CONTRATO_OPTIONS,
      },
      {
        name: "contrato_lee_nota",
        label: "Nota",
        kind: "textarea",
        placeholder: "Detalle del acompañamiento",
        columnSpan: "full",
      },
    ],
  },
  {
    ...
    description:
      "Nivel de apoyo y observaciones sobre la comprensión del contrato.",
    fields: [
      {
        name: "contrato_comprendido_nivel_apoyo",
        label: "Nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "contrato_comprendido_observacion",
        label: "Observación",
        kind: "select",
        options: CONTRATACION_COMPRENDE_CONTRATO_OPTIONS,
      },
      {
        name: "contrato_comprendido_nota",
        label: "Nota",
        kind: "textarea",
        placeholder: "Hallazgos o aclaraciones",
        columnSpan: "full",
      },
    ],
  },
  {
    ...
    description:
      "Claridad sobre el tipo de contrato, jornada y cláusulas.",
    fields: [
      {
        name: "contrato_tipo_nivel_apoyo",
        label: "Nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "contrato_tipo_observacion",
        label: "Observación",
        kind: "select",
        options: CONTRATACION_TIPO_CONTRATO_OBSERVACION_OPTIONS,
      },
      {
        name: "contrato_tipo_contrato",
        label: "Tipo de contrato valor",
        kind: "select",
        options: CONTRATACION_TIPO_CONTRATO_OPTIONS,
      },
      {
        name: "contrato_jornada",
        label: "Jornada laboral",
        kind: "select",
        options: CONTRATACION_JORNADA_OPTIONS,
      },
      {
        name: "contrato_clausulas",
        label: "Cláusulas del contrato",
        kind: "select",
        options: CONTRATACION_CLAUSULAS_OPTIONS,
      },
      {
        name: "contrato_tipo_nota",
        label: "Nota",
        kind: "textarea",
  ...
  },
  {
    ...
    description:
      "Frecuencia, forma de pago y soporte requerido para comprenderlas.",
    fields: [
      {
        name: "condiciones_salariales_nivel_apoyo",
        label: "Nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "condiciones_salariales_observacion",
        label: "Observación",
        kind: "select",
        options: CONTRATACION_CONDICIONES_SALARIALES_OPTIONS,
      },
      {
        name: "condiciones_salariales_frecuencia_pago",
        label: "Frecuencia de pago",
        kind: "select",
        options: CONTRATACION_FRECUENCIA_PAGO_OPTIONS,
      },
      {
        name: "condiciones_salariales_forma_pago",
        label: "Forma de pago",
        kind: "select",
        options: CONTRATACION_FORMA_PAGO_OPTIONS,
      },
      {
        name: "condiciones_salariales_nota",
        label: "Nota",
        kind: "textarea",
        placeholder: "Aclaraciones salariales",
        columnSpan: "full",
      },
    ],
  },
  {
    ...
    description:
      "Seguimiento a prestaciones y beneficios asociados al cargo.",
    fields: [
      {
        name: "prestaciones_cesantias_nivel_apoyo",
        label: "Cesantías nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "prestaciones_cesantias_observacion",
        label: "Cesantías observación",
        kind: "select",
        options: CONTRATACION_PRESTACIONES_OPTIONS,
      },
      {
        name: "prestaciones_cesantias_nota",
        label: "Cesantías nota",
        kind: "textarea",
        placeholder: "Detalle de cesantías",
        columnSpan: "full",
      },
      {
        name: "prestaciones_auxilio_transporte_nivel_apoyo",
        label: "Auxilio transporte nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "prestaciones_auxilio_transporte_observacion",
        label: "Auxilio transporte observación",
        kind: "select",
        options: CONTRATACION_PRESTACIONES_OPTIONS,
      },
      {
        name: "prestaciones_auxilio_transporte_nota",
        label: "Auxilio transporte nota",
        kind: "textarea",
        placeholder: "Detalle de auxilio de transporte",
        columnSpan: "full",
      },
      {
        name: "prestaciones_prima_nivel_apoyo",
        label: "Prima nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "prestaciones_prima_observacion",
        label: "Prima observación",
        kind: "select",
        options: CONTRATACION_PRESTACIONES_OPTIONS,
      },
      {
        name: "prestaciones_prima_nota",
        label: "Prima nota",
        kind: "textarea",
        placeholder: "Detalle de prima",
        columnSpan: "full",
      },
      {
        name: "prestaciones_seguridad_social_nivel_apoyo",
        label: "Seguridad social nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "prestaciones_seguridad_social_observacion",
        label: "Seguridad social observación",
        kind: "select",
        options: CONTRATACION_PRESTACIONES_OPTIONS,
      },
      {
        name: "prestaciones_seguridad_social_nota",
        label: "Seguridad social nota",
        kind: "textarea",
        placeholder: "Detalle de seguridad social",
        columnSpan: "full",
      },
      {
        name: "prestaciones_vacaciones_nivel_apoyo",
        label: "Vacaciones nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "prestaciones_vacaciones_observacion",
        label: "Vacaciones observación",
        kind: "select",
        options: CONTRATACION_PRESTACIONES_OPTIONS,
      },
      {
        name: "prestaciones_vacaciones_nota",
        label: "Vacaciones nota",
        kind: "textarea",
        placeholder: "Detalle de vacaciones",
        columnSpan: "full",
      },
      {
        name: "prestaciones_auxilios_beneficios_nivel_apoyo",
        label: "Beneficios nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "prestaciones_auxilios_beneficios_observacion",
        label: "Beneficios observación",
        kind: "select",
        options: CONTRATACION_PRESTACIONES_OPTIONS,
      },
      {
        name: "prestaciones_auxilios_beneficios_nota",
        label: "Beneficios nota",
        kind: "textarea",
  ...
  },
  {
    ...
    description:
      "Conocimiento del conducto regular, trámites y permisos.",
    fields: [
      {
        name: "conducto_regular_nivel_apoyo",
        label: "Conducto regular nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "conducto_regular_observacion",
        label: "Conducto regular observación",
        kind: "select",
        options: CONTRATACION_CONDUCTO_REGULAR_OPTIONS,
      },
      {
        name: "descargos_observacion",
        label: "Diligencia de descargos",
        kind: "select",
        options: CONTRATACION_DESCARGOS_OPTIONS,
      },
      {
        name: "tramites_observacion",
        label: "Trámites administrativos",
        kind: "select",
        options: CONTRATACION_TRAMITES_OPTIONS,
      },
      {
        name: "permisos_observacion",
        label: "Solicitud de permisos",
        kind: "select",
        options: CONTRATACION_PERMISOS_OPTIONS,
      },
      {
        name: "conducto_regular_nota",
        label: "Nota",
        kind: "textarea",
        placeholder: "Detalle del conducto regular",
        columnSpan: "full",
      },
    ],
  },
  {
    ...
    description:
      "Causales de finalización de contrato y rutas de atención.",
    fields: [
      {
        name: "causales_fin_nivel_apoyo",
        label: "Causales fin nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "causales_fin_observacion",
        label: "Causales fin observación",
        kind: "select",
        options: CONTRATACION_CAUSALES_OPTIONS,
      },
      {
        name: "causales_fin_nota",
        label: "Causales fin nota",
        kind: "textarea",
        placeholder: "Detalle de causales de fin de contrato",
        columnSpan: "full",
      },
      {
        name: "rutas_atencion_nivel_apoyo",
        label: "Rutas de atención nivel de apoyo",
        kind: "select",
        options: CONTRATACION_NIVEL_APOYO_OPTIONS,
      },
      {
        name: "rutas_atencion_observacion",
        label: "Rutas de atención observación",
        kind: "select",
        options: CONTRATACION_RUTAS_OPTIONS,
      },
      {
        name: "rutas_atencion_nota",
        label: "Rutas de atención nota",
        kind: "textarea",
        placeholder: "Detalle de rutas de atención",
        columnSpan: "full",
      },
    ],
  },
...
function getRowFieldError(
  ...
  const fieldError = (candidate as Record<string, { message?: string }>)[
    fieldName
  ];
  ...
  return (
    <div className={cn("space-y-1", field.columnSpan === "full" && "sm:col-span-2")}>
      <FormField
        ...
        required={!isOptionalContratacionField(field.name)}
        error={error}
      >
        {field.kind === "select" ? (
          <select
              ...
              onChange: (event) => {
                ...
                const updates = getPrefixedDropdownUpdates({
                  ...
                  getOptions: (targetFieldId) =>
                    getContratacionSelectOptions(targetFieldId),
                });

                Object.entries(updates).forEach(([targetFieldId, targetValue]) => {
                  setValue(
                    `vinculados.${index}.${targetFieldId}` as Path<ContratacionValues>,
                    targetValue,
                    {
                      shouldDirty: true,
                      shouldTouch: true,
...
function ContratacionVinculadoRowContent({
  index,
  row,
  register,
  setValue,
  ...
  const modifiedFieldIds = useMemo(
    () =>
      loadedSnapshot
        ? new Set(getContratacionUsuariosRecaModifiedFieldIds(loadedSnapshot, row))
        : new Set<string>(),
    [loadedSnapshot, row]
  );
  ...
  return (
    <div className="space-y-5">
      {loadedSnapshot ? (
        ...
        >
          Estás modificando datos cargados desde usuarios RECA. Los cambios se
          guardarán al finalizar.
        </div>
      ) : null}
