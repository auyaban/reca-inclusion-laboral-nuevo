...
type EvaluacionCompanySectionProps = {
...
export function EvaluacionCompanySection({
  empresa,
  fechaVisita,
  modalidad,
  nitEmpresa,
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start gap-3 rounded-2xl border border-reca-100 bg-reca-50 p-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Esta evaluacion ya quedo asociada a{" "}
            <span className="font-semibold">{empresa.nombre_empresa}</span>.
          </p>
          <p className="mt-1 text-xs text-gray-500">
            El bloque resume el snapshot operativo de la empresa y conserva los
            tres datos base que siguen editables en web.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <ReadonlyField label="Numero de NIT" value={nitEmpresa || empresa.nit_empresa} />
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5">
        <div className="mb-4">
          ...
          <p className="mt-1 text-xs text-gray-500">
            Estos tres campos siguen editables mientras se completa la migracion
            del documento largo.
          </p>
        </div>
