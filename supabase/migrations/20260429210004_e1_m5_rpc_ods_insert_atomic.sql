-- E1-M5: RPC ods_insert_atomic con columnas explícitas
-- Inserción atómica de usuarios_nuevos + ods en una sola transacción
...
declare
  ...
  v_usuario jsonb;
begin
  -- 1. Insertar usuarios nuevos (staging)
  ...
  loop
    ...
    on conflict (cedula_usuario) do update set
      ...
      discapacidad_usuario = excluded.discapacidad_usuario,
      genero_usuario = excluded.genero_usuario,
      fecha_ingreso = excluded.fecha_ingreso,
      tipo_contrato = excluded.tipo_contrato,
      cargo_servicio = excluded.cargo_servicio
    returning id into v_usuario_id;
  end loop;

  -- 2. Insertar ODS con columnas explícitas
  ...
  values (
    coalesce((p_ods->>'id')::uuid, gen_random_uuid()),
    p_ods->>'id_servicio',
